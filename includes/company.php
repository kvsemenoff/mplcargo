<section class="section section__padding section__db-company-padding">
	<div class="container">
		<div class="row">
			<div class="col-md-12">
			...
			<div class="col-md-6">
				<div class="db-company-box">
					...
					<p>
						...
						Компания MLP Cargo занимается<br> транспортировкой одежды, текстиля и сумок <br> оптом из Турции и Европы в Россию. Доставляем <br> товар в любую точку РФ (при авиадоставке —<br>
						в любой город с аэропортом).
					</p>
				</div>
			</div>
		</div>
